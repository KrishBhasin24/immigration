			...
			<table class="col-md-3 contract_table text-black">
				<tbody class="text-left">
					<tr>
						...
						<td><?php echo $key_data['lead_receipt']['id']; ?></td>
					</tr>
					<tr>
						<td>File Number:</td>
					...
					<tr>
						<td>Date:</td>
						<td><?php echo date("d-m-Y", strtotime($key_data['lead_receipt']['payment_date'])); ?>
						</td>
					</tr>
					<tr>
						<td>Received with thanks on Behalf of Smart International Immigration Solutions Inc an amount of CAD$</td>
						<td><?php echo $key_data['lead_receipt']['current_payment']; ?></td>
					</tr>
					<tr>
						<td>Payment Mode</td>
						<td><?php echo $key_data['lead_receipt']['payment_mode']; ?></td>
					</tr>
					<tr>
						<td>Authorization Number</td>
						<td><?php echo $key_data['lead_receipt']['authorization_number']; ?></td>
					</tr>
					<tr>
						<td>Issued By</td>
						<td><?php echo $key_data['lead_receipt']['issued_by']; ?></td>
					</tr>
