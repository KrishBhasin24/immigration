...
!function($) {
		...
		SweetAlert.prototype.init = function() {
	        $('.sa-params').click(function(){
		        ...
		        swal({   
		            title: "Are you sure?",   
		            text: "You will not be able to Re-Assign this case to anyone else!",   
		            type: "warning",   
		            ...
		            if (isConfirm) { 
						...
						swal({
					            title: "Assigned!",
					            text: "Lead has been Assigned!",
					            type: "success"
					        }, function() {
					            window.location = "<?php echo Router::url(array("controller" => "Admins", "action" => "getLead")); ?>";
				        	});
					} else {
		            	swal("Cancelled", "Case Still Unassigned!", "error");   
		            } 
		        });
		    });
	 	},
...
function caseAssign(lead_id,user_id){
	...
	var callUrl = "<?php echo Router::url(array('controller'=>'Leads','action'=>'leadAssignToCaseprocessing')); ?>";
