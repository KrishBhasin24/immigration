                                 ...
                                 <?php foreach ( $key_data['leadPayment'] as $payment) { ?>
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <?php $dat = $payment['id']; ?>
                                            <div class="btn-group mb-5">
                                            	<a style="cursor: pointer;" href="" class="btn btn-rounded btn-yellow mb-5 btn-info" onClick=<?php echo 'print_receipt('.$dat.')'; ?>><i class="fa fa-edit"></i>Print</a>
                                            </div>
                                        </td> 
                                    </tr>   
                                <?php } ?>
                                 ...
                                 <?php foreach ( $key_data['leadRefund'] as $payment) { ?>
                                    <tr>
                                        ...
                                        <td> 
                                            ...
                                            <?php $ref = $payment['id']; ?>
                                            <div class="btn-group mb-5">
                                            	<a style="cursor: pointer;" href="" class="btn btn-rounded btn-yellow mb-5 btn-info" onClick=<?php echo 'print_refund('.$ref.')'; ?>><i class="fa fa-edit"></i>Print</a>
                                            </div>
                                        </td> 
                                    </tr>   
                                <?php } ?>
