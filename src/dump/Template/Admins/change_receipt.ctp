    	...
    	<div class="col-lg-9 col-12">
			<div class="box">
				<div class="box-header with-border">
					<h4 class="box-title">Edit Receipt</h4>
					<?php echo $this->Form->create($key_data['receipt'], array('action' => 'changeReceipt','controller'=>'Admins','class'=>'form-horizontal form-element','novalidate')); ?>
		                                ...
		                                <div class="row">
				                            <div class="col-md-6">
				                                <div class="form-group">
				                                	<div class="controls">
														<?php echo $this->Form->hidden('lead_id',array('class'=>'form-control','value'=> $key_data['receipt']['lead_id'])); ?>
														<?php echo $this->Form->hidden('account_lead_id',array('class'=>'form-control','value'=> $key_data['receipt']['account_lead_id'])); ?>
		                ...
		                <div class="modal-footer modal-footer-uniform">
		                	<?php echo $this->Html->link('<i class="fa fa-mail-reply"></i> Back',['controller' => 'Admins', 'action' => 'manageReceipt',$key_data['receipt']['lead_id']],['class'=>'btn btn-danger','escape' => false]); ?>
