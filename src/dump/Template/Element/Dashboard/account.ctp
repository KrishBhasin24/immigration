 ...
 ?>
 	...
 	<div class="col-xl-3 col-md-6 col-12">
			<div class="flexbox flex-justified text-center bg-info mb-30 pull-up">
			  ...
			  <div class="py-30 bg-white text-dark">
				<div class="font-size-30 countnm"><?php echo $account['case_count']['total_case']; ?></div>
	...
	<div class="col-xl-2 col-md-6 col-12">
		<div class="flexbox flex-justified text-center bg-warning mb-30 pull-up">
		  ...
		  <div class="py-30 bg-white text-dark">
			<div class="font-size-30 countnm"><?php echo $account['case_count']['un_processed']; ?></div>
	...
	<div class="col-xl-2 col-md-6 col-12">
		<div class="flexbox flex-justified text-center bg-success mb-30 pull-up">
		  ...
		  <div class="py-30 bg-white text-dark">
			<div class="font-size-30 countnm"><?php echo $account['case_count']['filed']; ?></div>
	...
	<div class="col-xl-2 col-md-6 col-12">
		<div class="flexbox flex-justified text-center bg-danger mb-30 pull-up">
		  ...
		  <div class="py-30 bg-white text-dark">
			<div class="font-size-30 countnm"><?php echo $account['case_count']['approved']; ?></div>
	...
	<div class="col-xl-2 col-md-6 col-12">
		<div class="flexbox flex-justified text-center bg-info mb-30 pull-up">
		  ...
		  <div class="py-30 bg-white text-dark">
			<div class="font-size-30 countnm"><?php echo $account['case_count']['in_process']; ?></div>
				...
				<div class="row px-3">
					...
					<div class="col-12 col-lg-5">
					  <ul class="chart-legend clearfix pt-30">
						<li><h4><strong>Total Transection:  $<span><?php echo $account['total_transection']; ?></span>	</strong></h4></li>
						<li><h4><strong>Total Payment Received:  $<span id="payment"><?php echo $account['total_payment']; ?></span></strong></h4></li>
						<li><h4><strong>Total Payment Refund:  $<span id="refund"><?php echo $account['total_refund']; ?></span></strong></h4></li>
					  </ul>
					</div>
			 	</div>
			</div>
				...
				<div class="box-body">
					<div class="table-responsive">
						<table id="dash_user" class="table table-striped">
							...
							<tbody>
								<?php foreach ($account['link'] as $links) {?>
									<tr>
