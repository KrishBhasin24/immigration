...
<aside class="main-sidebar">
  <section class="sidebar">
        ...
        <?php
          if(strpos($link, 'payment-report') !== false || strpos($link, 'active-files') !== false ){ $Reportclass = "active menu-open"; }
          else{$Reportclass = "";}
        ?>
        <li class="treeview <?php echo $Reportclass; ?>">
            <a href="#">
              <i class="mdi mdi-notification-clear-all "></i>
              <span>Reports</span>
              <span class="pull-right-container">
            ...
            <ul class="treeview-menu">
              <?php 
                  if(strpos($link, 'payment-report') !== false ){ $midReport = "menu-open"; $child = "display:block"; }
                  else{$midReport = ""; $child = "";}
              ?>
              <li class="treeview <?php echo $midReport; ?>">
                <a href="#">
                  <i class="mdi mdi-notification-clear-all "></i>
                  ...
                  <ul class="treeview-menu " style="<?php echo $child; ?>">
                    <li class="<?php echo $Reportclass; ?>"><?php echo $this->Html->link('<i class="mdi mdi-toggle-switch-off"></i>Payment Report',['controller' => 'Reports', 'action' => 'paymentReport'],['escape' => false]); ?> </li>
                  </ul>    
              </li>
               <?php 
                  if(strpos($link, 'active-files') !== false ){ $midReport = "menu-open"; $child = "display:block"; }
                  else{$midReport = ""; $child = "";}
              ?>
              <li class="treeview <?php echo $midReport; ?>">
                <a href="#">
                  <i class="mdi mdi-notification-clear-all "></i>
                  <span>Case Processing Reports</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu " style="<?php echo $child; ?>">
                    <li class="<?php echo $Reportclass; ?>"><?php echo $this->Html->link('<i class="mdi mdi-toggle-switch-off"></i>Active Files',['controller' => 'Reports', 'action' => 'activeFiles'],['escape' => false]); ?> </li>
                  </ul>
              </li>
            </ul>
        </li>
