  ...
  <section class="sidebar">
    	<ul class="sidebar-menu" data-widget="tree">
        	...
        	<?php if(empty($user['permissions'])){ 
		        	  if(strpos($link, 'manage-case') !== false || strpos($link, 'edit-case') !== false || strpos($link, 'manage-all-case') !== false  ){ $Caseclass = "active menu-open"; }
			          else{$Caseclass = "";}
	        ?>
    		<li class="treeview <?php echo $Caseclass; ?>">
        		...
        		<ul class="treeview-menu">
        			<?php 
		        	  if(strpos($link, 'manage-case') !== false  ){ $Manageclass = "active menu-open"; }
			          else{$Manageclass = "";}
	        		?>
        			<li class="<?php echo $Manageclass; ?>"><?php echo $this->Html->link('<i class="mdi mdi-toggle-switch-off"></i>Manage Case',['controller' => 'Admins', 'action' => 'manageCase'],['escape' => false]); ?> </li>
        			<?php  if(strpos($link, 'manage-all-case') !== false  ){ $AllCaseclass = "active menu-open"; }
			          else{$AllCaseclass = "";} ?>
        			<li class="<?php echo $AllCaseclass; ?>"><?php echo $this->Html->link('<i class="mdi mdi-toggle-switch-off"></i>Manage All Cases',['controller' => 'Admins', 'action' => 'manageAllCase'],['escape' => false]); ?> </li>
    				</ul>
    		</li>
    		<?php }else{
